...
*******************************************************************************/
u8 MNVIC_u8EnableInt(NVIC_HW_PRIORITY  copy_IntId)
{
...
u8 MNVIC_u8DisableInt(NVIC_HW_PRIORITY  copy_IntId)
{
    if(copy_IntId >= 0 && copy_IntId <32)
    {
...
u8 MNVIC_u8EnableInts(NVIC_HW_PRIORITY copy_IntId[], u8 copy_u8ArraySize)
{
    u8 Local_u8Counter;
...
u8 MNVIC_u8DisableInts(NVIC_HW_PRIORITY copy_IntId[], u8 copy_u8ArraySize)
{
    u8 Local_u8Counter;
    for(Local_u8Counter = 0;Local_u8Counter < copy_u8ArraySize;Local_u8Counter++)
    {
...
u8 MNVIC_u8IsIntActive(NVIC_HW_PRIORITY  copy_IntId)
{
...
u8 MNVIC_u8SetIntpending(NVIC_HW_PRIORITY  copy_IntId)
{
    if(copy_IntId >= 0 && copy_IntId <32)
    {
...
u8 MNVIC_u8ClrIntpending(NVIC_HW_PRIORITY  copy_IntId)
{
    if(copy_IntId >= 0 && copy_IntId <32)
    {
...
u8 MNVIC_u8SetIntspending(NVIC_HW_PRIORITY copy_IntId[], u8 copy_u8ArraySize)
{
    u8 Local_u8Counter;
    for(Local_u8Counter = 0;Local_u8Counter < copy_u8ArraySize;Local_u8Counter++)
    {
...
u8 MNVIC_u8ClrIntspending(NVIC_HW_PRIORITY copy_IntId[], u8 copy_u8ArraySize)
{
    u8 Local_u8Counter;
    for(Local_u8Counter = 0;Local_u8Counter < copy_u8ArraySize;Local_u8Counter++)
    {
...
u8 MNVIC_u8IsIntPending(NVIC_HW_PRIORITY  copy_IntId)
{
    u8 Int_Status;
    if(copy_IntId >= 0 && copy_IntId <32)
    {
...
u8 MNVIC_u8SetPriority(s8 copy_s8IntId, u8 copy_u8GroupPriority, u8 copy_u8SubPriority)
{
    #define SCB_AIRCR   *((volatile u32 * const)(0xE000ED00  + 0X0C))
    //external int
    SCB_AIRCR = NVIC_GROUP_SUB_DISTRIBUTION;
    u8 Local_u8Priority = copy_u8SubPriority | (copy_u8GroupPriority << ((NVIC_GROUP_SUB_DISTRIBUTION - BASE_GROUP_VALUE) / GROUP_STEP));
    if(copy_s8IntId >= 0)
    {
...
u8 MNVIC_u8EnableInterrupts(u8 copy_RegId, u32 copy_RegValue)
{
    if(copy_RegId == 0)
    {
...
u8 MNVIC_u8DisableInterrupts(u8 copy_RegId, u32 copy_RegValue)
{
    if(copy_RegId == 0)
    {
...
u8 MNVIC_u8SetInterruptspending(u8 copy_RegId, u32 copy_RegValue)
{
    if(copy_RegId == 0)
    {
...
u8 MNVIC_u8ClrInterruptspending(u8 copy_RegId, u32 copy_RegValue)
{
    if(copy_RegId == 0)
    {
