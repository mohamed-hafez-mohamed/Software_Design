...
u8 MEXTI_u8Init(u8 copy_LineIndex, EXTI_Lines_t copy_Line[], EXTI_IntSignalSensitive_t copy_Mode)
{
    u8 Local_u8lines;
    switch(copy_Mode)
    {
...
u8 MEXTI_u8EnableEXTI(u8 copy_LineIndex, EXTI_Lines_t copy_Line[])
{
    u8 Local_u8lines;
    for(Local_u8lines = 0;Local_u8lines < copy_LineIndex;Local_u8lines++)
    {
...
u8 MEXTI_u8DisableEXTI(u8 copy_LineIndex, EXTI_Lines_t copy_Line[])
{
    u8 Local_u8lines;
    for(Local_u8lines = 0;Local_u8lines < copy_LineIndex;Local_u8lines++)
    {
...
u8 MEXTI_u8SwTrigger(u8 copy_LineIndex, EXTI_Lines_t copy_Line[])
{
    u8 Local_u8lines;
    for(Local_u8lines = 0;Local_u8lines < copy_LineIndex;Local_u8lines++)
    {
...
u8 MEXTI_u8SetSignalLatch(u8 copy_LineIndex, EXTI_Lines_t copy_Line[], EXTI_IntSignalSensitive_t copy_Mode)
{
    u8 Local_u8lines;
    switch(copy_Mode)
    {
...
u8 MEXTI_u8InitISRWithFunction(u8 Copy_Index, EXTI_InterruptId_t Copy_ExtiId[], EXTI_voidPtrToFunction Copy_PtrFunction[], void * Copy_Parameter[])
{
    u8 Local_u8Counter;
